...
const Sidenav = () => {
  ...
  return (
    <>
      <nav className='absolute bottom-0 left-0 right-0 bg-white my-5 rounded-md w-full mb-3 p-3 lg:p-0 text-green-900 lg:mb-0 lg:absolute lg:top-0 lg:-left-[11.5rem] lg:w-[11rem] lg:max-w-[11rem] lg:bg-transparent lg:text-white'>
