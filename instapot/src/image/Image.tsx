  ...
  return (
    <>
      <div className='border-t border-gray-200 p-3 bg-white rounded text-black flex flex-col gap-2 mb-2'>
        <div>
          <img src='https://cdn.pixabay.com/photo/2019/04/27/21/56/cactus-4161380_1280.jpg' alt={"id"} className='rounded-md border-2 border-gray-300' />
        </div>
        <div className='flex flex-col gap-1 px-1'>
          <div className='flex flex-row gap-2 justify-between mb-2'>
            <div className='flex flex-row gap-4'>
              <Liked likes={[1]} userID={1} />
